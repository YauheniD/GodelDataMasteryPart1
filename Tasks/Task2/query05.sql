SELECT HumanResources.Employee.BusinessEntityID, 
		...
		CASE 
			WHEN Person.PersonPhone.PhoneNumberTypeID = 1 THEN Person.PersonPhone.PhoneNumber
			WHEN Person.PersonPhone.PhoneNumberTypeID != 1 THEN NULL
		END AS PhoneNumber
...
WHERE Person.Person.PersonType IN ('EM','SP')
